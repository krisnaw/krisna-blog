...
function TabsList({
  ...
  variant = "default",
  ...props
}: React.ComponentProps<typeof Tabs.List> & VariantProps<typeof tabsListVariants>) {
  return (
    <Tabs.List
      data-slot="tabs-list"
...
export { TabsRoot as Tabs, TabsList, TabsTrigger, TabsContent, tabsListVariants }
