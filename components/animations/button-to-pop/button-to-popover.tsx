...
import {CustomSpinner} from "@/components/animations/button-to-pop/custom-spinner";

export default function ButtonToPopover() {
  ...
  return (
    <div className={styles.feedbackWrapper}>
      <motion.button
        ...
        className={styles.feedbackButton} style={{borderRadius: 8}}>
                ...
                (
                  <form className={styles.feedbackForm}
                    ...
                    <textarea name="feedback" id="feedback"
                              ...
                              autoFocus required className={styles.textarea}/>
                    <div className={styles.feedbackFooter}>
                      <svg className={styles.dottedLine} width="352" height="2" viewBox="0 0 352 2" fill="none"
                           xmlns="http://www.w3.org/2000/svg">
                        ...
                        <svg width="6" height="12" viewBox="0 0 6 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <g clipPath="url(#clip0_2029_22)">
                            ...
                            <path
                              ...
                              stroke="#E6E7E8" strokeWidth="1" strokeLinejoin="round"/>
                          </g>
                          <defs>
                      ...
                      <button type="submit" className={styles.submitButton}>
                        <AnimatePresence mode="popLayout" initial={false}>
                          ...
                          >
                            {formState === "loading" ? (
                              <CustomSpinner size={14} color="rgba(255, 255, 255, 0.65)"/>
                            ) : (
