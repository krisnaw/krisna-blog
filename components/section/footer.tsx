...
export default function Footer() {
    return (
        <footer className="space-y-6 py-24">
          ...
          <div className="grid grid-cols-5 gap-6">
            ...
            <div className="bg-blue-600 text-white rounded-2xl px-10 py-10 col-span-2">
              sm
            </div>

            <div className="bg-gray-100 rounded-2xl px-10 py-10 col-span-3">
              sm
            </div>
          ...
          <div className="grid grid-cols-4 gap-6">
            ...
            <div className="bg-gray-100 rounded-2xl px-10 py-10 col-span-1 flex items-center justify-center">
            ...
            <div className="bg-gray-100 rounded-2xl px-10 py-10 col-span-1">
              sm
            </div>
            <div className="bg-gray-100 rounded-2xl px-10 py-10 col-span-1">
              sm
